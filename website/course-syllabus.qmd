...
2. Aprendizado Supervisionado
   ...
   h. Ajuste de parâmetros
   i. Métodos de conjunto (ensemble methods)
      i. Bagging
      ii. Boosting
      iii. Stacking
...
FACELI, Katti. **Inteligência artificial: uma abordagem de aprendizado de máquina.**
Rio de Janeiro: LTC, 2011. 378 p.
...
NWANGANGA, Fred; CHAPPLE, Mike. **Practical machine learning in R.** Indianapolis:
John Wiley & Sons, 2020.

ABU-MOSTAFA, Yaser S.; MAGDON-ISMAIL, Malik; LIN, Hsuan-Tien. **Learning from
data.** New York: AMLBook, 2012.
